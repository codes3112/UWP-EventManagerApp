    ...
    internal class PhotoStreamModel : INotifyPropertyChanged
    {
        ...
        public void InitializePhotoCollection()
        {
            ...
            for (var i = 0; i < 5; i++)
            {
                ...
                {
                    StreamItems.Add(new PhotoModel(new Uri("ms-appx:///SamplePhotos/Band1.png")));
                    StreamItems.Add(new PhotoModel(new Uri("ms-appx:///SamplePhotos/Band2.jpg")));
                }
                if (App.EventModel.EventName == "Hackathon")
                {
                    StreamItems.Add(new PhotoModel(new Uri("ms-appx:///SamplePhotos/Hackathon1.png")));
                    StreamItems.Add(new PhotoModel(new Uri("ms-appx:///SamplePhotos/Hackathon2.jpg")));
                }
                if (App.EventModel.EventName == "Ariana Grande Musical")
                {
                    StreamItems.Add(new PhotoModel(new Uri("ms-appx:///SamplePhotos/ArianaGrande.jpg")));
                }
                if (App.EventModel.EventName == "Microsoft Ignite")
                {
                    StreamItems.Add(new PhotoModel(new Uri("ms-appx:///SamplePhotos/MSIgnite1.jpg")));
                    StreamItems.Add(new PhotoModel(new Uri("ms-appx:///SamplePhotos/MSIgnite2.png")));
                }
            }
        }
    }
